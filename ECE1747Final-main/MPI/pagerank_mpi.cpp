...
void Read_from_txt_file(char* filename, Node *Nodes, int Ndata)
{
...
int main(int argc, char** argv)
{
    ...
    {
        std::cout << "Error in arguments! Arguments required: graph filename, # of data\n" << std::endl;
    }
    ...
    Read_from_txt_file(filename, Nodes, Ndata);
